...
int nAnonymizeBeetleAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Beetle
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Beetle
    // Mac: ~/Library/Application Support/Beetle
    // Unix: ~/.Beetle
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Beetle";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Beetle.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "beetled.pid"));
